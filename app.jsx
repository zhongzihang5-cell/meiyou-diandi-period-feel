      ...
      <PeriodFeelOverlay
        ...
        onComplete={(text)=>{
          const entry = buildTimelineEntry(text, [], {
            voice:{duration:'10″'},
            tagLayout:'v3',
            tags:periodPlan === 'plan2' ? [{cat:'心情'},{cat:'症状'}] : [{cat:'流量'},{cat:'心情'},{cat:'症状'}],
          });
          setTimeline(blocks=>{
